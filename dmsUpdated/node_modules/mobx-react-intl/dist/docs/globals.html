...
<head>
	...
	<title>mobx-react-intl | mobx-react-intl</title>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<h1 id="internationalization-with-mobx-and-react-intl">Internationalization with mobx and react-intl</h1>
			<p>A library to use react-intl along with a mobx store for the selected locale with typescript support.   </p>
			<p><a href="https://badge.fury.io/js/mobx-react-intl"><img src="https://badge.fury.io/js/mobx-react-intl.svg" alt="npm version"></a>
				<a href="https://circleci.com/gh/Sqooba/mobx-react-intl"><img src="https://circleci.com/gh/Sqooba/mobx-react-intl.svg?style=svg" alt="CircleCI"></a>
			...
			<p>Since an example is worth a thousand words. </p>
			<p>You can see this example running on <a href="https://stackblitz.com/edit/react-kmgtt3">Stackblitz</a></p>
...
render(&lt;App /&gt;, document.getElementById('root'));
			...
			<h2 id="i18n-mobx-store">I18n mobx store</h2>
			<p><code>LocaleStore</code> is a mobx store that contains the locale data and persists the
			locale to the browser LocalStorage (if it exists). </p>
			<p>The store expects the default locale and the translations for all supported locales as arguments.</p>
			<h2 id="intl-provider">Intl Provider</h2>
			<p><code>MobxIntlProvider.js</code>: Creates the I18n provider for mobx. Note that it relies on <code>IntlProvider</code> from <code>react-intl</code>. </p>
			<p>This component has the same interface as <a href="https://github.com/yahoo/react-intl/wiki/Components#intlprovider"><code>IntlProvider</code></a>
			except that the <code>locale</code> and <code>messages</code> attributes are injected through mobx.  </p>
			<h2 id="using-locale-data-in-other-stores-">Using locale data in other stores.</h2>
			<p>It is possible to also use the i18n without being in the react scope. For example when initializing a
				store that needs locale data, just pass the locale store as a prop. You can see that a <code>formatMessage</code> method
			is implemented in the <code>LocaleStore</code> for this case. </p>
			<h2 id="example">Example</h2>
			<p>A running example with some file structure is provided in <code>examples/simple-app</code>. </p>
			<h3 id="run-the-example-locally-">Run the example locally:</h3>
			<p>To run this <code>create-react-app</code> project, run the following commands (<code>yarn</code> can be replaced by <code>npm</code>)</p>
			<pre><code class="lang-bash">yarn install
yarn start
</code></pre>
			<h3 id="introduction">Introduction</h3>
			<p>To have internationalization (i18n) working with react, mobx and react-intl,
			we need to: </p>
			<ol>
				<li>Create a store for the i18n data (locale used and locale data)</li>
				<li>Uhe use a custom provider to provide internationalization from the mobx store. </li>
				<li>Inject the provider to UI components.</li>
				<li>Use the provided code. </li>
			</ol>
			<h3 id="i18n-translations-">I18n translations.</h3>
			<p>We create two files to maintain locale data: </p>
			<p><code>./translations/en.js</code> and <code>./translations/de.js</code> provide translations for English and German. </p>
			<h2 id="language-switcher">Language Switcher</h2>
			<p><code>./Toolbar.js</code> is the component used to switch from one language to another. </p>
			<h2 id="home">Home</h2>
			<p><code>./Home.js</code> is a UI component that uses i18n to display texts. </p>
			<h2 id="application-initializer">Application initializer</h2>
			<p>In <code>./App.js</code> we finally wrap up all components. </p>
			<p>The app is initialized initialized with the Provider and shows the <code>Home</code> component. </p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-external-module"><a href="modules/_localestore_.html" class="tsd-kind-icon">"<wbr>Locale<wbr>Store"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_mobxintlprovider_.html" class="tsd-kind-icon">"<wbr>Mobx<wbr>Intl<wbr>Provider"</a></li>
							<li class="tsd-kind-external-module"><a href="modules/_mobx_react_intl_.html" class="tsd-kind-icon">"mobx-<wbr>react-<wbr>intl"</a></li>
						</ul>
					</section>
				</div>
			</section>
