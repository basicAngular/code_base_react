...
class KremplerForm extends Form {
...
// export default new KremplerForm();
export default KremplerForm;

// export default new KremplerForm();

// class KremplerForm extends React.Component {
//     render() {
//         return (
//             <Form
//                 defaultValues={{
